...
public class TesteProfessorRegistrandoFaltaNosAlunos {
	public static void main(String[] args) throws ParseException {
		...
		Disciplina calcu = new Disciplina();
		calcu.setNome("Calculo 4");
		calcu.setCodigo("COD66");
		...
		Frequencia banco_dados = new Frequencia();
		...
		Frequencia calculo_4 = new Frequencia();
		calculo_4.setAluno(alunoDAO.porId(3L));
		calculo_4.setDisciplina(calcu);
